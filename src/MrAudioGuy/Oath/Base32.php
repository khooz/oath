<?php
	...
	class Base32 implements BaseConverterInterface
	{
		...
		public static function fromBin ($str)
		{
			...
			preg_match_all('/.{8}/', $str, $chrs);
			$chrs = array_map('static::_mapcharset', $chrs[0]);
		...
		public static function toBin ($str)
		{
			...
			$str = join('', array_map('static::_mapbin', str_split($str)));
		...
		public static function toString ($str)
		{
			...
			return static::bin2str(static::tobin($str));
		}
		...
		public static function setCharset ($charset = self::csRFC3548)
		{
			...
			{
				static::$_charset = strtoupper($charset);
			}
			else
			{
